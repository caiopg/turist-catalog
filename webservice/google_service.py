...
from flask import request, url_for, session as login_session
...
google_service = Blueprint(name='google', import_name=__name__)
...
@google_service.route('/gdisconnect')
def gdisconnect():
    """
...
@google_service.route('/gconnect', methods=['POST'])
def gconnect():
    """
